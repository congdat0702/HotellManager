...
namespace HotelManager.DAO
{
    public class CustomerDAO
    {
        ...
        internal bool InsertCustomer(string id, string customerName, string idCustomerType, string idCard, string address, DateTime dateOfBirth, int phoneNumber, string sex, string nationality)
        {
