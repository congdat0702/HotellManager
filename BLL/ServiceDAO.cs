...
namespace HotelManager.DAO
{
    public class ServiceDAO
    {
        ...
        internal bool InsertService(string id, string name, string idtype, int price)
        {
        ...
        internal bool UpdateService(string id, string name, string idServiceType, int price)
        {
