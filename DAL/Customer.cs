...
namespace HotelManager.DTO
{
    public class Customer
    {
        ...
        public Customer(string id,string idCard, string name, string idcustomerType, string address, int phoneNumber, string sex, string nationality,DateTime dateOfBirth)
        {
            this.Id = id;
            this.IdCard = idCard;
            this.Name = name;
        ...
        public Customer(DataRow row)
        {
            ...
            this.IdCustomerType =row["idcustomerType"].ToString();
        ...
        public string IdCustomerType { get => idCustomerType; set => idCustomerType = value; }
