...
namespace HotelManager
{
    public partial class fServiceType : Form
    {
        ...
        {
            fAddServiceType f = new fAddServiceType();
            f.ShowDialog();
            f.Show();
            ...
            comboboxID.SelectedItem = dataGridViewServiceType.RowCount -1;
        }
        ...
        private ServiceType GetServiceTypeNow()
        {
            ...
            if (comboboxID.Text == string.Empty)
                serviceType.Id = GetAutomaticID();
            else
                serviceType.Id = comboboxID.Text;
        ...
        {
            return
                GetIDAutomaticDAO.Instance.Actomatic_ID("ServiceType", "ID");
        }
        #endregion
