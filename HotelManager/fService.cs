    ...
    public partial class fService : Form
    {
        ...
        private void ChangeText(DataGridViewRow row)
        {
            ...
            else
            {
                ...
                comboBoxServiceType.SelectedItem = row.Cells["colIdServiceType"].Value.ToString();
        ...
        {
            return
                GetIDAutomaticDAO.Instance.Actomatic_ID("Service", "ID");
        }
        #endregion
