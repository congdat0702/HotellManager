...
namespace HotelManager
{
    public partial class fBookRoomDetails : Form
    {
        ...
        public void UpdateCustomer()
        {
            ...
            CustomerDAO.Instance.UpdateCustomer(idCustomer, txbFullName.Text, txbIDCard.Text, idCustomerType, int.Parse(txbPhoneNumber.Text), dpkDateOfBirth.Value, txbAddress.Text, cbSex.Text, cbNationality.Text);
        }
        ...
        {
            return
                GetIDAutomaticDAO.Instance.Actomatic_ID("BookRoom", "ID");
        }
    }
}
